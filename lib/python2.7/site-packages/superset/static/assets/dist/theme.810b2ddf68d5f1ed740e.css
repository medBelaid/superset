...
.has-success .form-control:focus {
  border-color: #1d5527;
  -webkit-box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 6px #4ac15f;
  box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 6px #4ac15f;
}
...
.has-warning .form-control:focus {
  border-color: #977101;
  -webkit-box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 6px #feca33;
  box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 6px #feca33;
}
...
.has-error .form-control:focus {
  border-color: #940201;
  -webkit-box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 6px #fe3130;
  box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 6px #fe3130;
}
...
.nav-tabs .dropdown-toggle.btn,
.nav-tabs .dropdown-toggle.btn:hover,
.nav-tabs .dropdown-toggle.btn:active,
.nav-tabs .dropdown-toggle.btn:focus,
.nav-tabs .btn-group.open .dropdown-toggle.btn,
.nav-tabs .btn-group.open .dropdown-toggle.btn:hover,
.nav-tabs .btn-group.open .dropdown-toggle.btn:active,
.nav-tabs .btn-group.open .dropdown-toggle.btn:focus {
  border-color: transparent;
  background-color: transparent;
  box-shadow: none;
}
...
table .success .btn-default,
.table .success .btn-default,
table .warning .btn-default,
.table .warning .btn-default,
table .danger .btn-default,
.table .danger .btn-default,
table .info .btn-default,
.table .info .btn-default {
  color: #555555;
}
.has-warning .help-block,
...
.panel-primary .panel-title h1,
.panel-primary .panel-title h2,
.panel-primary .panel-title h3,
.panel-primary .panel-title h4,
.panel-primary .panel-title h5,
.panel-primary .panel-title h6 {
  margin: 10px 0 0 0;
  font-weight: bold;
}
.panel-primary .close {
...
g.annotation-container line {
  stroke: #00A699;
}
g.annotation-container rect.annotation {
  stroke: #00A699;
  fill-opacity: 0.1;
  stroke-width: 1;
}
